...
void CGameManager::Init(InningHalf Player1Harf)
{
	...
	switch (Player1Harf)
	{
	case CGameManager::InningHalf::Top:
		m_tGameState.offense = Team::Player1;
		m_tGameState.defense = Team::Player2;
		m_bPlayer1Top = true;
		break;
	case CGameManager::InningHalf::Bottom:
...
void CGameManager::AddBallCount()
{
	m_tCount.m_nBallCount++;
}

void CGameManager::AddStrikeCount(bool isFoul)
{
...
void CGameManager::AddOutCount()
{
	m_tCount.m_nOutCount++;
}

void CGameManager::AddScore()
{
...
void CGameManager::SetBaseState(int base, bool state)
{
	m_tCount.m_bBaseState[base] = state;
}

bool CGameManager::GetBaseState(int base)
{
	return m_tCount.m_bBaseState[base];
}

void CGameManager::ResetCount()
{
	m_tCount.m_nStrikeCount = 0;
	m_tCount.m_nBallCount = 0;
...
CGameManager::Team CGameManager::GetOffenseTeam()
{
	return m_tGameState.offense;
}

CGameManager::Team CGameManager::GetDefenseTeam()
{
	return m_tGameState.defense;
}

void CGameManager::SetEndInplay(InplayElement ElemEndInplay, bool state)
{
	m_bInplay[(int)ElemEndInplay] = state;
}

bool CGameManager::GetEndInplay()
{
...
void CGameManager::DrawBallCount()
{
#ifdef _IMGUI
...
void CGameManager::DrawBaseCount()
{
#ifdef _IMGUI
	static DirectX::XMFLOAT2 debugpos = { 0.0f,0.0f };
