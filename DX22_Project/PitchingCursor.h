...
public:
	...
	/// <summary name="SetPos"> SetPos:カーソルの予測地点をセットする </summary>
	/// <param name="pos"> カーソルの座標 </param>
	void SetPredPos(DirectX::XMFLOAT2 pos);
	...
	/// <summary> GetPos:投球予測地点の座標を取得する </summary>
	/// <returns> 投球予測地点の座標 </returns>
	DirectX::XMFLOAT2 GetPredPos();
